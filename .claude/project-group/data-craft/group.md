...
| 통합 브랜치 | **`i-dev` 필수** (6개 저장소 전부 예외 없이 적용 — 기존 4 + 관리자 콘솔 2 `data-craft-admin`/`data-craft-admin-server`, 마스터 명시) |
...
| 보호 브랜치 (dev-merge `--delete-branch` 면제) | `i-dev`, `main` (6개 저장소 모두 적용) |
...
- **6개 저장소 (data-craft / data-craft-mobile / data-craft-ai-preview / data-craft-server / data-craft-admin / data-craft-admin-server) 모두** WIP → i-dev 경로 필수.
- 핫픽스 / 1줄 수정도 예외 없음.
