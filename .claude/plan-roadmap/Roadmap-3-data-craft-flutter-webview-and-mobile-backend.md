# Roadmap 3: data-craft Flutter 웹뷰 통합 · BE/DB 신규 · 네이티브 브리지 — ⛔ 폐기 (2026-06-11)

> ⛔ **폐기됨 (2026-06-11, 마스터 지시)**. 본 로드맵은 더 이상 실행 대상이 아니다. 22개 프롬프트 전부 미착수(🔴) 상태에서 폐기 결정됨 — 진행 중·완료된 작업 손실 없음. 아래 프롬프트·설명 본문은 향후 참고용으로 **보존**하되, 어느 것도 실행하지 말 것. 모바일 방향이 다시 살아나면 신규 로드맵으로 재작성한다.
