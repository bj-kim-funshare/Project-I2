...
🔴 /plan-enterprise data-craft — [트랙 C] 프로모션 admin CRUD: admin-server CRUD(쓰기 전 setPromotionAuditContext → promotion_audit_log, verifyAdminToken+dbMode+dataPool(mode) 재사용) + admin-web 목록/생성/편집/활성토글/현황(활성·만료예정·eligibility 분포)/통계
