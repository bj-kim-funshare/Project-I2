...
2. `.Codex/project-group/<leader>/dev.md` exists.
...
- Read `.Codex/project-group/<leader>/dev.md` → `dev_targets[]`.
- Read `.Codex/project-group/<leader>/deploy.md` → `deploy_targets[]` (for `build_command`).
