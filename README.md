...
| `advisor()` tool | `claude-sonnet-4-6` | `.claude/settings.json` `advisorModel` — 비용 절감 의식적 trade-off (강한→약한 자문 inversion 허용) |
...
- 산출물: 17 스킬 + 11 sub-agent + 1 공용 절차 + CLAUDE.md + patch-note 부트스트랩
